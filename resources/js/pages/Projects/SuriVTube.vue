...
import { ref, shallowRef, computed, onUnmounted, onMounted, onBeforeMount, watch } from 'vue'
...
onBeforeMount(() => {
  appLoaderStore.begin();
})

onMounted(() => {
  chatbotAgentStore.selectedAgent = 'suriVTubeAgent';
  chatbotAgentStore.suggestions = tm('projects.SuriAi.chatbotSuggestions') as string[];
