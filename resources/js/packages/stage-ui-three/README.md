...
- `@dtrensuri/stage-ui-three/trace`: local Eventa trace bus and snapshot helpers.
- `@dtrensuri/stage-ui-three/composables/vrm`: VRM loading and animation helpers.
- `@dtrensuri/stage-ui-three/utils/vrm-preview`: one-off VRM preview rendering.
...
`@dtrensuri/stage-ui-three/trace` provides:
...
- Use `@dtrensuri/stage-ui-three/trace` when you need Three/VRM runtime telemetry without routing through Vue parent chains.
