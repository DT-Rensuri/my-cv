...
```ts
import type { WebSocketEvent, WebSocketEventOf, WebSocketEvents } from '@dtrensuri/plugin-protocol/types'

import { moduleAnnounce, moduleAuthenticate } from '@dtrensuri/plugin-protocol/types'
```
