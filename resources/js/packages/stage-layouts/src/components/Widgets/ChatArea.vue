...
import { HearingConfig } from '@dtrensuri/stage-ui/components/scenarios/dialogs/audio-input/index'
import { useAudioAnalyzer } from '@dtrensuri/stage-ui/composables'
...
import { BasicTextarea } from '@dtrensuri/ui'
