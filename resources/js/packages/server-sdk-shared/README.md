...
```shell
ni @dtrensuri/server-sdk-shared -D
pnpm i @dtrensuri/server-sdk-shared -D
```

```typescript
import type { WireMessage } from '@dtrensuri/server-sdk-shared'

import { newMessages, pullMessages, sendMessages } from '@dtrensuri/server-sdk-shared'
```
