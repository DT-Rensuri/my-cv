...
import type { EmotionPayload } from '@dtrensuri/stage-ui/constants/emotions'
import type { ChatProvider, SpeechProviderWithExtraOptions } from '@xsai-ext/providers/utils'

import { createPlaybackManager, createSpeechPipeline } from '@dtrensuri/pipelines-audio'
import { ThreeScene } from '@dtrensuri/stage-ui-three'
import { animations } from '@dtrensuri/stage-ui-three/assets/vrm'
import { useDelayMessageQueue, useEmotionsMessageQueue } from '@dtrensuri/stage-ui/composables/queues'
import { llmInferenceEndToken } from '@dtrensuri/stage-ui/constants'
import { EMOTION_EmotionMotionName_value, EMOTION_VRMExpressionName_value, EmotionThinkMotionName } from '@dtrensuri/stage-ui/constants/emotions'
import { useAudioContext, useSpeakingStore } from '@dtrensuri/stage-ui/stores/audio'
