...
import Header from '@dtrensuri/stage-layouts/components/Layouts/Header.vue'
import InteractiveArea from '@dtrensuri/stage-layouts/components/Layouts/InteractiveArea.vue'
import MobileHeader from '@dtrensuri/stage-layouts/components/Layouts/MobileHeader.vue'
import MobileInteractiveArea from '@dtrensuri/stage-layouts/components/Layouts/MobileInteractiveArea.vue'
import workletUrl from '@dtrensuri/stage-ui/workers/vad/process.worklet?worker&url'

import { BackgroundProvider } from '@dtrensuri/stage-layouts/components/Backgrounds'
import { useBackgroundThemeColor } from '@dtrensuri/stage-layouts/composables/theme-color'
import { useBackgroundStore } from '@dtrensuri/stage-layouts/stores/background'
import { HoloCoupon } from '@dtrensuri/stage-ui/components'
import { ViewControlSlider, WidgetStage } from '@dtrensuri/stage-ui/components/scenes'
import { useAudioRecorder } from '@dtrensuri/stage-ui/composables/audio/audio-recorder'
import { useVAD } from '@dtrensuri/stage-ui/stores/ai/models/vad'
...
import { useHearingSpeechInputPipeline } from '@dtrensuri/stage-ui/stores/modules/hearing'
import { useSettings, useSettingsAudioDevice } from '@dtrensuri/stage-ui/stores/settings'
