...
import { OnboardingDialog, OnboardingStepAnalyticsNotice, ToasterRoot } from '@dtrensuri/stage-ui/components'
import { useInferencePreload } from '@dtrensuri/stage-ui/composables'
import { initializeAnalytics, isAnalyticsAvailableInBuild } from '@dtrensuri/stage-ui/libs/analytics'
import { usePiniaSynced } from '@dtrensuri/stage-ui/libs/pinia'
import { useAuthStore } from '@dtrensuri/stage-ui/stores/auth'
import { useCharacterOrchestratorStore } from '@dtrensuri/stage-ui/stores/character'
...
import { useModsServerChannelStore } from '@dtrensuri/stage-ui/stores/mods/api/channel-server'
...
import { configureAsDefaultsIfEmpty, unconfigureAuthenticationProviders } from '@dtrensuri/stage-ui/stores/modules/default'
...
import { useOnboardingStore } from '@dtrensuri/stage-ui/stores/onboarding'
...
import { ErrorBoundary, useTheme } from '@dtrensuri/ui'
